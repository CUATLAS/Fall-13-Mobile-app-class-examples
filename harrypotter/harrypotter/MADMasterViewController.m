...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [characterChoosen objectForKey:@"name"]; //assigns the value of name to the cell
    return cell;
}
...
{
    NSDictionary *characterChoosen = [self.characters objectAtIndex:indexPath.row]; //assigns dictionary item of the row
